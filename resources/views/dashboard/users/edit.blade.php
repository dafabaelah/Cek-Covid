            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="username" placeholder="Masukan Username" name="username" value="{{$user->username ?? old('username')}}">
                        @error('name') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-grup">
                        <label for="is_admin" class="form-label">Tingkatan user ?</label>
                        <select class="form-select" name="is_admin">
                        <option value="0" selected>bukan administrator</option>
